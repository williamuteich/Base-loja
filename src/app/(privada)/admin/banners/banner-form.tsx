    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-3">
                    ...
                    >
                        {desktopPreview || (banner?.imageDesktop && !selectedDesktopFile) ? (
                            <Image
                                src={desktopPreview || `/uploads/${banner?.imageDesktop}`}
                                alt="Desktop preview"
                                fill
                ...
                <div className="space-y-3">
                    ...
                    >
                        {mobilePreview || (banner?.imageMobile && !selectedMobileFile) ? (
                            <Image
                                src={mobilePreview || `/uploads/${banner?.imageMobile}`}
                                alt="Mobile preview"
                                fill
            ...
            <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
                ...
                <button
                    type="submit"
                    className="flex items-center gap-2 px-8 py-2.5 bg-slate-900 border border-slate-900 text-white rounded-xl text-sm font-bold hover:bg-slate-800 shadow-lg shadow-slate-900/10 transition-all disabled:opacity-70 disabled:cursor-not-allowed"
                    disabled={isSaving}
                >
                    {isSaving ? (
                        <>
